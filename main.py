...
[{color}]◎══════════════════════════════════════◎
[FFD700]◉ —͞NAYAN乡ㅤ友! BOT [9400D3]➤ /spnff ◉
"""
    return result
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]—͞NAYAN乡ㅤ友! [00FF00]___ —͞NAYAN乡1M BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000] INSTAGRAM : @NAYAN1M\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]—͞NAYAN乡ㅤ友!ㅤ [FFFF00]!!
"""
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][FFFF00] "Arey sala agar main noob hu toh tu kya hai? 😂"
...
"""
    ...
    try:
        ...
        # Completion message
        completion_msg = f"""[B][C][FFFF00]ARA B@SD@K EYA TITAL DAKH OR BOL KON NOB HAI M@D@RC4O@D
"""
        await safe_send_message(chat_type, completion_msg, uid, chat_id, key, iv)
...
[{color1}]━━━━━━━━━━━━━━━━━━
[FFD700]◉ —͞NAYAN乡ㅤ友! BOT [FF69B4]➤ /joke ◉
[{color1}]━━━━━━━━━━━━━━━━━━
"""
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FFD700]◉ —͞NAYAN乡ㅤ友! BOT [00FF7F]➤ /frt ◉
"""
...
"""
                                ...
                                if chance >= 90:
                                    emoji = "💖💖💖💍"
                                    status = "Puri zindagi ka sathi! PERFECT MATCH"
                                    color = "FF1493"
                                elif chance >= 70:
                                    emoji = "💕💕💗"
                                    status = "Jabardast jodi! Amazing Couple!"
                                    color = "FF69B4"
                                elif chance >= 50:
                                    emoji = "💗💗"
                                    status = "Accha rishta! Good Relationship!"
                                    color = "FFB6C1"
                                elif chance >= 30:
                                    emoji = "💓"
                                    status = "Koshish karni hogi! Keep Trying!"
                                    color = "FFA500"
                                else:
                                    emoji = "💔"
                                    status = "Aur zyada pyaar chahiye! Need More Love!"
                                    color = "FFFF00"
...
[{color}]◎━━━━━━━━━━━━━━━━━━━━━━━━━━━◎
[FFFFFF]{message}
[FFD700]◉ —͞NAYAN乡ㅤ友! BOT [FF69B4]➤ /grt ◉
"""
...
[FFFF00]➕ PLUS (Addition):
[FFFFFF]/mth 1+1    →  2
[FFFFFF]/mth 1+2    →  3
[FFFFFF]/mth 100+200 → 300
[FFFFFF]/mth 1.5+2.5 → 4

[FFFF00]➖ MINUS (Subtraction):
[FFFFFF]/mth 5-3    →  2
[FFFFFF]/mth 100-50 →  50
[FFFFFF]/mth 3-2    →  1

[FFFF00]✖️ GUN (Multiplication):
[FFFFFF]/mth 3*4    →  12
[FFFFFF]/mth 5×6    →  30
...
"""
                        ...
                        if inPuTMsG.strip() == "/admin":
                            ...
                            admin_message = """
[C][B][FF0000]╔═════════════╗
[FFFFFF] ✨ YT= @NAYAN1M FOLLOW   
[FFFFFF]      THANKS FOR USE MY BOT❤️   
[FFFFFF]           AND THANKS FOR YOUR SUPPORT❤️ 
[FF0000]╠═════════════╣
[FFD700] ⚡ OWNER REAL NAME : [FFFFFF]NAYAN乡1M
[FFD700] ✨ KISIKO GUILD BOT [FF0000] PURCHASE KARNA HAI TO DM KARO, [00FFFF] INSTAGRAM: @NAYAN1M
[FF0000]╠═════════════╣
[FFD700] ✨ Developer —͟͞͞ </> —͞NAYAN乡1M ❄️  ⚡
[FFD700]╚═════════════╝"""
                                ...
                                if len(parts) < 2:
                                    ...
                                    if name.lower() in [n.lower() for n in BLOCKED_NAMES]:
                                        error_msg = (
                                            ...
                                            f"[FFFFFF]মাদা🤫রচো🤫দ তো🤫র আব্বা {name}'!\n"
                                            f"[FF0000]বা🤫পে🤫র গা🤫লি দিতে চাস লা🤫রা দিসে ⛔\n"
                                            f"[FFFFFF]ওনার এর নাম লেখতা সোস MC⚠️."
                                        )
                                        await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                                        continue
                                    ...
                                    messages = [
                                        "{Name} khan...ki man...gi !!",
                                        "harami, main teri maa ki chodunga. !!",
                                        "{Name} madarchod, teri maa ki 5G speed se chodun.🤫দি !!",
                                        "{Name} loti veshya, main condom pahankar tumhari maa ke saath sex karunga. !!",
                                        "{Name} besharm veshya, main roz 300 taka mein sevaen deti hun. !!",
                                        "{Name} abe kamini, tujhe kitne patiyon ki zaroorat hai?!!",
                                        "{Name} kamini, main tujhe 100 baar chodunga. !!",
                                        "{Name} main tumhare muh par thukta hun. !!",
                                        "{Name} are chudakkad randi, ek land se tera man nahin bharta—tujhe kitne chahiye? !!",
                                        "{Name}jab tak aap kisi ko maarte nahin, tab tak aapko santushti nahin milti, hai na? !!",
                                        "{Name} kamine, tere saath sex karne mein bhi mujhe ghin aati hai.!!",
                                        "{Name} kamini, ja apne baap ko maar dal.",
                                        "{Name} har manzil par service ke liye aap kitna charge karte han?!!",
                                        "{Name} main tumhari puri nasl ki dhajjiyan uda dunga.",
                                        "{Name} 12 pati churane wali 🤫 !!"
                                            ]
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    if name.lower() in [n.lower() for n in BLOCKED_NAMES]:
                                        error_msg = (
                                            f"[B][C][FF0000]⚠️ WARNING!\n"
                                            f"[FFFFFF]sla owner kiya tarako hila diya'{name}'!\n"
                                            f"[FF0000]owner ka name ku likh raha hai⛔\n"
                                            f"[FFFFFF]BC owner ka name dakh or mara kiya  tumhara larki samajta ho ."
                                        )
                                        await safe_send_message(response.Data.chat_type, error_msg, uid, chat_id, key, iv)
                                        continue
                                    ...
                                    messages = [
                                      "{Name} khan...ki man...gi !!",
                                        ...
                                        "{Name} main tumhari puri nasl ki dhajjiyan uda dunga.",
                                        "{Name} 12 pati churane wali 🤫 !!",
                                        "{Name} tumhara liya ak line bolta hu\n                         jahabhi/ usjagamai phone use diya or battary fol jaiyaga dosh \n hara mara  r4ndi jo kiya life maj upar mai  jauaga to nahi tik pauaga ⚠️⚠️!!",
                                            ]
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    if name.lower() in [n.lower() for n in BLOCKED_NAMES]:
                                        eror_msg = (
                                            f"[B][C][FF0000]⚠️ WARNING!\n"
                                            f"[FFFFFF]অনার এগুলার প্রতি ইন্টারেস্ট না '{name}'!\n"
                        ...
                        if inPuTMsG.strip().startswith('/rt '):
                            ...
                            try:
                                ...
                                if len(parts) < 2:
                                    ...
                                    # Rest of your code continues here...
                                    messages = [
                                        "আরে {Name} তো একটা আস্ত বট! 😂",
                                        "{Name} গেম খেলা বাদ দিয়ে লুডু খেল যা! 🤣",
                                        "{Name} এর হেডশট রেট মাইনাসে চলে গেছে! 📉",
                                        "{Name} ল্যান্ড করার আগেই লবিতে চলে যায়! 🪂💨",
                                        "সবাই সাবধানে থেকো, {Name} নামের বট গেমে ঢুকেছে! 🤖",
                                        "আরে {Name}, তুই তো প্রো... প্রো-ম্যাক্স লেভেলের বট! 🤡",
                                        "{Name} এর থেকে তো ট্রেনিং গ্রাউন্ডের পুতুলও ভালো খেলে! 🗿",
                                        "বুইয়া তো দূরের কথা, {Name} তো জোন সারভাইভ করতেই মরে যায়! ☠️",
                                        "ভাই {Name}, তুই কি বন্দুকের বদলে লাঠি নিয়ে খেলিস? 🦯",
                                        "ও ভাই! {Name} তো এনিমি দেখলে উল্টা দৌড় দেয়! 🏃‍♂️💨",
                                        "এনিমি দেখলে {Name} এর হাত-পা কাঁপে! 🥶",
                                        "{Name} এর মতো বট আমি জীবনেও দেখি নাই! 🤦‍♂️",
                                        "গেমের সবচেয়ে বড় বট অ্যাওয়ার্ড {Name} কে দেওয়া হোক! 🏆",
                                        "{Name} ভাই, তুই ফ্রি ফায়ার ডিলিট করে দে! 🗑️",
                                        "{Name} এর গেমপ্লে দেখলে এনিমিও হাসতে হাসতে মরে যাবে! 😆",
                                        "{Name} এর কিল চুরি করার ট্যালেন্ট অস্কার পাওয়ার মতো! 🎭",
                                        "টিমমেট নক হলে {Name} সবার আগে পালায়! 🏃‍♂️",
                                        "গান স্কিন দিয়ে কী হবে, {Name} তো গুলি করতেই ভুলে যায়! 🔫",
                                        "{Name} তো গেম খেলে না, গেম {Name} কে নিয়ে খেলে! 🎮",
                                        "{Name} হলো ফ্রি ফায়ারের জীবন্ত লেজেন্ডারি বট! 👑"
                                            ]
...
[FF2C03]└─► [FFFDED]/ghost [code]"""
                            ...
                            s2 = """
[B][C][FF75EA]╭──────────╮
[FF75EA]│ㅤ[FFFB00] NAYAN乡 MENU 02ㅤㅤ[FF75EA]│
[FF75EA]╰──────────╯
...
[2BC0FF]════════════[FFFFFF][B]
❀️ DM FOR BOT PURCHASE 

[2BC0FF]❀️ JOIN FOR GUILD YOU GET BOT ACCES

[FCFEFF] WELCOME TO TEAM DISABLE 
